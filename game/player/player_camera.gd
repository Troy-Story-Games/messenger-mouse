...
func update_limits(camera_limits: CameraLimits) -> void:
    limit_left = camera_limits.position.x - offset.x
    limit_right = camera_limits.position.x + camera_limits.size.x - offset.x
    limit_top = camera_limits.position.y
    limit_bottom = camera_limits.position.y + camera_limits.size.y - offset.y
