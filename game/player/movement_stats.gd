...
@export var ground_acceleration: = 350.0
## Max horizontal speed
@export var ground_max_speed: = 125.0
## Friction applied to stop the charater when not moving
@export var ground_friction: = 600.0
## Force applied when jumping off the ground
@export var ground_jump_force: = 225.0
...
@export var air_acceleration: = 350.0
## Max horizontal speed in the air
@export var air_max_speed: = 125.0
...
@export var air_jump_force: = 225.0
...
@export var wall_jump_force: = 225.0
## Horizontal speed when wall jumping
@export var wall_jump_speed: = 125.0
